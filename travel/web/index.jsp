...
<script type="text/javascript">
    $(function () {
        //显示最热门的六个国内游的旅游路线
        $.post("route/findMostFavoriteRoutesByCid.do",{"cid": 4} ,function (data) {
            var html = "";
            if(data != null){
                ...
                $(".guone_r .row:eq(0)").html(html);
            }

        },"json");

    $.post("route/findMostFavoriteRoutesByCid.do",{"cid": 8} ,function (data) {
            var html = "";
            if(data != null){
